...
import { getEventFullMessage, getEventFullMessageValidateSchema } from './getEventFullMessage';
...
export default function eventsModule(router: Router) {
  ...
  router.get('/events/:id/message', validate(getEventFullMessageValidateSchema), userAuthorizationRequired(getEventFullMessage));
